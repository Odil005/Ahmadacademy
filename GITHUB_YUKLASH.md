...
Hozir ishlatayotgan Supabase loyihangizda avvalgi migratsiyalar bor bo'lsa, yangi `supabase/migrations/20260812100000_admin_desk_metrics.sql` faylini Supabase **SQL Editor**ga nusxalab, bir marta **Run** qiling.
